...
module.exports = (app) => {
	...
	app.get('/test', (req, res) => {
		knex.select('*').from('test').then((data) => res.send(data)).catch((err) => res.send(err));
	});
	...
	app.post('/markets', markets.addNewMarket);
	app.put('/markets/:id', markets.findByIdAndReplace);
	...
	app.post('favorites', favorites.add);
